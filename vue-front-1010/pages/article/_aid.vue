      ...
      >
        <div class="detailBox tcommonBox">
          <span class="s-round-date">
            <span
              class="month"
              v-html="showInitDate(detailObj.gmtCreate, 'month') + '月'"
            ></span>
            <span
              class="day"
              v-html="showInitDate(detailObj.gmtCreate, 'date')"
            ></span>
          </span>
          <header>
            <h1>
            ...
            <h2>
              ...
              <span>{{ detailObj.gmtCreate }}</span> •
              <i class="fa fa-fw fa-eye"></i>{{ detailObj.viewCount }} 次阅览
            </h2>
            <div class="ui label">
...
export default {
  ...
  methods: {
    ...
    getArticleDetail() {
      article.getArticle(this.aid).then((response) => {
        this.detailObj = response.data.data.article;
        const markdownIt = mavonEditor.getMarkdownIt();
        // markdownIt.re
        this.detailObj.content = markdownIt.render(this.detailObj.content);
      });
    },
  },
};
